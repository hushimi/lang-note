...
- **[Test]**: PHPUnit test (all principles)
...
- **Backend**: `app/Actions/`, `app/Data/`, `app/Models/`, `app/Services/`, `app/Http/Controllers/`
- **Frontend**: `resources/js/Pages/`, `resources/js/Components/`, `resources/js/Components/ui/`
- **Tests**: `tests/Feature/`, `tests/Unit/`
- **Types**: `resources/js/types/generated.d.ts` (auto-generated)

Example tasks:
- `T015 [P] [US1] [Data] Create UserData DTO in app/Data/UserData.php with #[TypeScript]`
- `T016 [US1] [Action] Create CreateUserFromOAuth action in app/Actions/Auth/CreateUserFromOAuth.php`
- `T017 [US1] [Page] Create Dashboard page in resources/js/Pages/Dashboard.tsx`
...
- [ ] T001 Create project structure per implementation plan (app/Actions/, app/Data/, resources/js/Pages/, etc.)
- [ ] T002 Initialize [language] project with [framework] dependencies (verify required packages)
- [ ] T003 [P] Configure linting and formatting tools (Prettier 2-space, Pint for PHP)
- [ ] T004 [P] Setup TypeScript generation script (`npm run generate-types`)
